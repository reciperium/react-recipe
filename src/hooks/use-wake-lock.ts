/**
 * Source: https://github.com/jorisre/react-screen-wake-lock/
 *
 * Installation doesn't work, so we copy this small hook here.
 */
...
export const useWakeLock = ({
  ...
  const [released, setReleased] = React.useState<boolean>(true);
